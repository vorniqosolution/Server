...
//       return res
//         .status(400)
//         .json({ success: false, message: "Already checked-in or cancelled" });
//     }

//     // 1. Create a Guest record using your existing logic
//     const stayDays = Math.ceil((r.endAt - r.startAt) / (1000 * 60 * 60 * 24));
...
//       paymentMethod: "cash", // adapt as needed
//       createdBy: req.user.userId,
//     });

//     // 2. Flip reservation & room status
//     r.status = "checked-in";
//     await r.save();
...
//     res.json({
//       success: true,
//       message: "Checked in reservation and created Guest",
//       data: { reservation: r, guest },
//     });
//   } catch (err) {
